<footer class="footer">
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-6 mb-5 d-flex align-items-center text-align-center justify-content-center">
                <div class="wrapper wrapper--social">
                    <h3 class="subheader text-center text-white mb-3">Find me on:</h3>
                    <ul class="social-list">
                        <li class="social-list__item"><a href="https://github.com/Hajneken" class="social-list__link"><svg class="svg-icon svg-icon--social" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li class="social-list__item"><a href="https://www.linkedin.com/in/hynek-zemanec-8a8175106/" class="social-list__link"><svg class="svg-icon svg-icon--social" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="510px" height="510px" viewBox="0 0 510 510" style="enable-background:new 0 0 510 510;" xml:space="preserve">
                                    <g>
                                        <g id="post-linkedin">
                                            <path d="M459,0H51C22.95,0,0,22.95,0,51v408c0,28.05,22.95,51,51,51h408c28.05,0,51-22.95,51-51V51C510,22.95,487.05,0,459,0z M153,433.5H76.5V204H153V433.5z M114.75,160.65c-25.5,0-45.9-20.4-45.9-45.9s20.4-45.9,45.9-45.9s45.9,20.4,45.9,45.9S140.25,160.65,114.75,160.65z M433.5,433.5H357V298.35c0-20.399-17.85-38.25-38.25-38.25s-38.25,17.851-38.25,38.25V433.5H204V204h76.5v30.6c12.75-20.4,40.8-35.7,63.75-35.7c48.45,0,89.25,40.8,89.25,89.25V433.5z" />
                                        </g>
                                    </g>
                                    <g></g>
                                    <g></g>
                        ...
                        <li class="social-list__item"><a href="https://twitter.com/hynas17?lang=cs" class="social-list__link"><svg class="svg-icon svg-icon--social" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="510px" height="510px" viewBox="0 0 510 510" style="enable-background:new 0 0 510 510;" xml:space="preserve">
                                    <g>
                                        <g id="post-twitter">
