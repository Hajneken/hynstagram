...
<form class="form" action="./controllers/topicCreator.php" method="post">
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="topicName" id="topicName" aria-describedby="Topic name" placeholder="Enter the name of new topic..." required>
    </div>
    <div class="form-group">
        <label for="topicDescription">Topic description (500 chracters max)</label>
        <textarea class="form-control" name="topicDescription" id="topicDescription" rows="3" placeholder="Briefly introduce the topic to your audience ..." required></textarea>
    </div>
